...
class RecipeView extends View{
    ...
    addHandlerUpdateServings(handler){
        this._parentElement.addEventListener('click', function (event){
            const clickedBtn = event.target.closest('.btn--increase-servings');
    ...
    addHandlerUpdateBookmark(handler){
        this._parentElement.addEventListener('click', function (event){
            const clickedBtn = event.target.closest('.btn--bookmark');
            if (!clickedBtn) return;
            handler();
        });
    }
    ...
    _generateMarkupIngredient(ing){
        return `
              <li class="recipe__ingredient">
                ...
                <div class="recipe__quantity">${ing.quantity ? new Fractional.Fraction(ing.quantity).toString() : ''}
                </div>
